...
export class Ciclo {
    ...
    public constructor(public startHour?: number, public startMinute?: number, public finishHour?: number, public finishMinute?: number, public id?: string, public notification?: boolean) {
